...
public class MusicChannelId {
    private ConnectionDAO conn;

    public MusicChannelId() {
    ...
    public String getIds(String serverId) {
        String retorno = null;
        try {
            String query = "SELECT * from guilds_musics_ids where serverid = " + serverId;
    ...
    public void setId(String guild, String id) throws SQLException {
        String insertQuery = "insert into guilds_musics_ids (serverid , channelId) values (? , ?)";
    ...
    public void changeId(String guild, String id) throws SQLException {
        String query = "Update guilds_musics_ids set channelId  = '" + id + "' where serverid = '" + guild + "'";
